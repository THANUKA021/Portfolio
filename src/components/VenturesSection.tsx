...
import { ShoppingCart, Shirt, ShoppingBag } from "lucide-react";
...
const VenturesSection = () => {
  ...
  return (
    <section id="ventures" className="section-padding bg-background" ref={ref}>
        ...
        <div className="space-y-6">
          {ventures.map((venture, i) => (
            <motion.div
              ...
              className="p-6 md:p-8 rounded-xl bg-card border border-border hover:border-primary/30 transition-all group"
            >
